...
{!name &&
            <form onSubmit={handleSubmit} className='w-[50%] h-[400px] bg-gray-100 shadow-2xl py-10 px-10  rounded-lg m-auto '>
                <label className='text-xl font-semibold mb-2'>Name: </label>
                <input type="text" name='name' onChange={handleChange} required value={data.name} className='w-full border rounded-lg py-2 px-2 mb-4 mt-2' />
                ...
                <button type='submit' className='btn py-2 px-4 hover:bg-blue-700 bg-purple-600 text-white rounded-lg text-xl mt-1'>Submit</button>
